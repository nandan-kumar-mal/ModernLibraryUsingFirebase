...
public class DataStructure_books extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = FirebaseDatabase.getInstance().getReference("Books")
                .orderByChild("topic").equalTo("Data Structure and Algorithm");
  ...
  //      database.addListenerForSingleValueEvent(valueEventListener);
    ...
    ValueEventListener valueEventListener = new ValueEventListener() {
        ...
        public void onCancelled(@NonNull @NotNull DatabaseError error) {
            Toast.makeText(DataStructure_books.this, "Cannot Load!", Toast.LENGTH_SHORT).show();
