...
public class Semester_II_books extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = FirebaseDatabase.getInstance().getReference("Books")
                .orderByChild("category").equalTo("Semester II");
    ...
    ValueEventListener valueEventListener = new ValueEventListener() {
        ...
        public void onCancelled(@NonNull @NotNull DatabaseError error) {
            Toast.makeText(Semester_II_books.this, "Cannot Load!", Toast.LENGTH_SHORT).show();
