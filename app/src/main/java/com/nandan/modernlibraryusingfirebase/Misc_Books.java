...
public class Misc_Books extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = FirebaseDatabase.getInstance().getReference("Books")
                .orderByChild("category").equalTo("Miscellaneous");
    ...
    ValueEventListener valueEventListener = new ValueEventListener() {
        ...
        public void onCancelled(@NonNull @NotNull DatabaseError error) {
            Toast.makeText(Misc_Books.this, "Cannot Load!", Toast.LENGTH_SHORT).show();
